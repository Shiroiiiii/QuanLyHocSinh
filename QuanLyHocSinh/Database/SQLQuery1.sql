...
END;
go
INSERT INTO HOCSINH VALUES ('HS001', 'LOP1012021', 'Nguyễn Văn A', 'Nam', '2006-03-15', '123 Đường ABC, Quận 1, Thành phố Hồ Chí Minh', 'nguyenvana@example.com')
INSERT INTO HOCSINH VALUES ('HS002', 'LOP1112021', 'Trần Thị B', 'Nữ', '2001-07-20', '456 Đường XYZ, Quận 2, Thành phố Hồ Chí Minh', 'tranthib@example.com')
INSERT INTO HOCSINH VALUES ('HS003', 'LOP1212021', 'Phạm Đức C', 'Nam', '2004-11-10', '789 Đường DEF, Quận 3, Thành phố Hồ Chí Minh', 'phamducc@example.com')
INSERT INTO HOCSINH VALUES ('HS004', 'LOP1012021', 'Trần Thanh Dương', 'Nam', '2006-04-25', '456 Đường XYZ, Quận 2, Thành phố Hồ Chí Minh', 'tranduong@example.com');
INSERT INTO HOCSINH VALUES ('HS005', 'LOP1112021', 'Nguyễn Thị Hằng', 'Nữ', '2005-09-15', '789 Đường MNO, Quận 3, Thành phố Hồ Chí Minh', 'nguyenhang@example.com');
INSERT INTO HOCSINH VALUES ('HS006', 'LOP1212021', 'Lê Văn Đức', 'Nam', '2004-12-10', '101 Đường QRS, Quận 4, Thành phố Hồ Chí Minh', 'levanduc@example.com');
INSERT INTO HOCSINH VALUES ('HS007', 'LOP1012021', 'Phạm Thị Hồng', 'Nữ', '2006-03-20', '111 Đường TUV, Quận 5, Thành phố Hồ Chí Minh', 'phamhong@example.com');
...
SELECT LOP.TenLop, 
       LOP.SiSo, 
       ROW_NUMBER() OVER (PARTITION BY LOP.TenLop ORDER BY HOCSINH.HoTen) AS STT, 
       HOCSINH.HoTen, 
       HOCSINH.GioiTinh, 
       HOCSINH.NgaySinh, 
       HOCSINH.DiaChi
